...
muscle -threads 16 -align NRSW_trees/3610LXG/3610_LXG.fasta -output NRSW_trees/3610LXG/aligned.fasta

# iqtree run with modelfinder plus , and 1000 bootstrap iterations 
iqtree -s NRSW_trees/3610LXG/aligned.fasta -m MFP -B 1000 
