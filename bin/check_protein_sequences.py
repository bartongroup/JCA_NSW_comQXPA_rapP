...
merged_df = pd.merge(merged_df,gene_results['rapP'], suffixes=[None, '_rapP'], on='genome', how = 'left')
merged_df.drop(['genome','description', 'description_comP','description_comX', 'description_comQ', 'description_rapP'], axis = 1, inplace=True)
